...
class HealthcareVettingWizard extends EditRecord
{
    ...
    {
        return HealthcareVettingSteps::steps();
    }
    ...
    protected function isComplianceChecklistComplete(): bool
    {
        ...
        return $record instanceof HealthcareCandidate && CandidateVettingRequirements::isComplete($record);
    }
